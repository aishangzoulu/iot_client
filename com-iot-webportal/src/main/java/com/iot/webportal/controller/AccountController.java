...
import com.iot.security.DesSecurityComponent;
import com.iot.utils.RequestUtils;
import com.iot.webportal.context.LoginContext;
import com.iot.webportal.cookie.CookieUtils;
import com.iot.webportal.dto.ResultCode;
import com.iot.webportal.dto.UserInfo;
import com.iot.webportal.service.UserService;
import com.iot.webportal.service.impl.WebApiResult;
...
public class AccountController extends ControllerBase {
    ...
    public ModelAndView regPost(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
        ...
        UserInfo userInfo = new UserInfo(loginName, pwd, null, null);
    ...
    public ModelAndView loginPost(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
        ...
        if (result.getCode() == ResultCode.USER_OK && result.getData() != null) {
            ...
            if (StringUtils.isNotBlank(loginName) && StringUtils.isNotBlank(pwd)) {
                LoginContext context = new LoginContext(result.getData().getId(), loginName, "");
